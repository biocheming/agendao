...
pub const KEYBINDINGS: &[HelpEntry] = {
    ...
    &[
        ...
        Binding("Ctrl+D", "Toggle diff detail (this turn)"),
        ...
        Binding("Alt+C", "Copy cursor block (OSC52)"),
        Binding("Alt+Shift+C", "Copy visible screen (OSC52)"),
        Binding("g/G · Home/End", "Jump top/bottom"),
        Binding("PgUp/PgDn · wheel", "Scroll transcript"),
        Section("─ Transcript search (Ctrl+F) ─"),
        Binding("type · ⌫", "Refine query (live match count)"),
        Binding("Enter / ↑", "Next / previous match (wrap)"),
        ...
        Binding(
            "/editor",
            "Open draft in $VISUAL / $EDITOR (Ctrl+G, alias: /edit)",
        ),
        ...
        Binding("/interrupt", "Interrupt current active turn (alias: /int)"),
        ...
        Binding("/queue", "Queue prompt for next turn (alias: /qprompt)"),
        ...
        Binding("/steer", "Steer active turn safe boundary (alias: /s)"),
        Binding("/themes", "Cycle theme (dark/light via Ctrl+P)"),
        Binding("/thinking", "Toggle thinking details"),
        Binding(
            "/details",
            "Toggle transcript detail policy (usage: /details thinking|tools|todo|subagents)",
        ),
