...
impl BlockingApiClient {
    ...
    pub fn get_session_repair_summary(
        &self,
        session_id: &str,
    ...
    pub fn query_global_repair(&self, query: &RepairQuery) -> anyhow::Result<RepairQueryResponse> {
    ...
    pub fn sync_skill_hub_semantic_conflict_review_candidates(
        &self,
        req: &SkillHubReviewCandidatesSyncRequest,
    ) -> anyhow::Result<SkillHubReviewCandidatesSyncResponse> {
        self.post_json(
