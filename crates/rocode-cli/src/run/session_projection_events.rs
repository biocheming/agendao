...
pub(super) type CliEventsQueryInput = rocode_command::interactive::InteractiveEventsQuery;
pub(super) type CliEventsCommandInput = rocode_command::interactive::InteractiveEventsCommand;
