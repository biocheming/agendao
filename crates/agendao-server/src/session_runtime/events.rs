...
use agendao_command::agent_presenter::output_block_to_web;
use agendao_command::output_blocks::OutputBlock;
use agendao_command::stage_protocol::{telemetry_event_names, StageEvent};
...
mod tests {
    ...
    use crate::ServerState;
    use agendao_command::output_blocks::{OutputBlock, StatusBlock};
    use agendao_command::stage_protocol::{telemetry_event_names, StageEvent};
    use agendao_types::{
    ...
    fn stage_event_maps_tool_started_to_transport_event() {
        let event = StageEvent {
            ...
            scope: agendao_command::stage_protocol::EventScope::Stage,
    ...
    fn stage_event_maps_session_status_to_transport_event() {
        let event = StageEvent {
            event_id: "evt_1".to_string(),
            scope: agendao_command::stage_protocol::EventScope::Session,
            stage_id: None,
            execution_id: None,
...
mod lifecycle_tests {
    use super::*;
    use agendao_command::stage_protocol::{telemetry_event_names, EventScope, StageEvent};
