    ...
    fn apply_live_slot_update(
        ...
        match live_identity.part_kind {
            agendao_types::LiveMessagePartKind::AssistantText => {
                ...
                let should_finalize = live_identity.phase == agendao_types::LivePartPhase::End;
            ...
            agendao_types::LiveMessagePartKind::AssistantReasoning => {
                ...
                let phase_is_end = live_identity.phase == agendao_types::LivePartPhase::End;
                {
                    let session_slots = self.live_slots.entry(session_id.to_string()).or_default();
            ...
            agendao_types::LiveMessagePartKind::ToolResult => {
