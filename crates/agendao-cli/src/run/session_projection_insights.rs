...
fn cli_tool_trajectory_band_label(band: agendao_types::ToolTrajectoryQualityBand) -> &'static str {
    match band {
...
fn cli_effective_policy_lines(policy: &agendao_types::SessionEffectivePolicyView) -> Vec<String> {
...
fn cli_provider_profile_summary(profile: &agendao_types::ProviderProfileDescriptorView) -> String {
    let mut parts = vec![
