use super::*;
use agendao_types::SkillHubSearchRequest;
    ...
    store
        .upsert_distribution(SkillDistributionRecord {
            ...
            installed: Some(SkillInstalledDistribution {
                ...
                workspace_skill_path: ".agendao/skills/review/remote-reviewer/SKILL.md".to_string(),
...
"#,
    ...
    assert_eq!(
        ...
        agendao_types::SkillSyncAction::Install
    );
...
"#,
    ...
    assert_eq!(
        ...
        agendao_types::SkillSyncAction::Update
    );
...
"#,
    ...
    assert_eq!(
        ...
        Some(&agendao_types::SkillSyncAction::SkipLocalModification)
    );
    assert_eq!(
        beta.map(|entry| &entry.action),
        Some(&agendao_types::SkillSyncAction::SkipDeletedLocally)
    );
...
"#,
    ...
    assert_eq!(
        ...
        agendao_types::SkillSyncAction::RemoveManaged
    );
...
"#,
    ...
    assert_eq!(
        ...
        agendao_types::SkillGuardStatus::Warn
    );
    ...
    let config = Config {
        skills: Some(SkillsConfig {
            hub: Some(SkillHubConfig {
                default_registries: Some(vec![agendao_config::SkillHubRegistrySourceConfig {
                    source_id: "registry:agendao/official".to_string(),
                    source_kind: SkillSourceKind::Registry,
                    locator: "https://skills.example.test/catalog.json".to_string(),
                    description: Some("Official AgenDao skill registry".to_string()),
                }]),
                ..Default::default()
            }),
            ..Default::default()
        ...
        skills: Some(SkillsConfig {
            hub: Some(SkillHubConfig {
                default_registries: Some(vec![
                    agendao_config::SkillHubRegistrySourceConfig {
...
fn search_source_indices_assigns_trust_official_for_bundled() {
    ...
    let snapshot = agendao_types::SkillSourceIndexSnapshot {
        source: SkillSourceRef {
            source_id: "bundled:core".to_string(),
            source_kind: SkillSourceKind::Bundled,
    ...
    assert_eq!(
        ...
        agendao_types::SkillTrustLevel::Official
    );
...
fn search_source_indices_trust_ranking_boosts_official_over_community() {
    ...
    governance
        .hub_store()
        .upsert_source_index(agendao_types::SkillSourceIndexSnapshot {
            source: SkillSourceRef {
...
fn search_source_indices_trust_ignores_source_id_naming_convention() {
    ...
    governance
        ...
        .upsert_source_index(agendao_types::SkillSourceIndexSnapshot {
            source: SkillSourceRef {
                source_id: "registry:agendao/official-trust-me".to_string(),
                source_kind: SkillSourceKind::Registry,
...
fn reconcile_artifact_cache_policy_evicts_expired_entries_from_disk() {
    let dir = tempdir().unwrap();
    let artifact_dir = dir.path().join(".agendao/state/skill/artifact-cache");
