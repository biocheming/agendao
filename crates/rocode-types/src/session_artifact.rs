...
impl SessionArtifactVersion {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::RocodeRustV1 => "rocode-rust/v1",
        }
    }
}
...
pub enum SessionDiagnosticsSidecarVersion {
    #[serde(rename = "rocode-rust/diagnostics/v1")]
...
impl SessionDiagnosticsSidecarVersion {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::RocodeRustDiagnosticsV1 => "rocode-rust/diagnostics/v1",
        }
    }
}
...
mod tests {
    ...
    fn entry_derives_diagnostics_sidecar_from_persisted_owners() {
        ...
        assert_eq!(
            ...
            serde_json::json!("rocode-rust/diagnostics/v1")
        );
        assert_eq!(
    ...
    fn import_envelope_ignores_invalid_diagnostics_sidecar_payload() {
        let payload = serde_json::json!({
            ...
            "diagnostics_sidecar": {
                "version": "rocode-rust/diagnostics/v999",
