...
mod tests {
    ...
    fn sample_custom_entry(provider_id: &str, npm: &str) -> ProviderArtifactEntry {
        ProviderArtifactEntry {
            ...
            profile: ProviderArtifactProfile {
                npm: npm.to_string(),
                api_family: rocode_types::ProviderArtifactApiFamily::CloseAiCompatible,
                api_shape: rocode_types::ProviderArtifactApiShape::Responses,
                transport: rocode_types::ProviderArtifactTransport::Bearer,
                usage_shape: rocode_types::ProviderArtifactUsageShape::CloseAiCachedTokens,
    ...
    fn export_provider_bundle_sorts_ids_and_sanitizes_descriptor_fields() {
        ...
        assert_eq!(
            ...
            rocode_types::ProviderArtifactApiShape::Responses
        );
    }
    ...
    fn import_provider_bundle_rejects_legacy_payload_without_explicit_adapter() {
        let envelope =
            ProviderArtifactImportEnvelope::Legacy(rocode_types::ProviderArtifactLegacyPayload {
