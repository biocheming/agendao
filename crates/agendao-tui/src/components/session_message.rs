...
mod tests {
    ...
    fn system_prompt_title_prefers_profile_identity_line() {
        let title = system_prompt_title(
            "You are AgenDao's request router.
...
line four",
    ...
    fn render_user_message_shows_multimodal_summary_and_warning_lines() {
        let msg = Message {
            ...
            tokens: crate::context::TokenUsage::default(),
            metadata: None,
            multimodal: Some(agendao_multimodal::PersistedMultimodalExplain {
                attachment_count: 1,
                ...
                attachments: vec![agendao_multimodal::PersistedMultimodalAttachmentInfo {
