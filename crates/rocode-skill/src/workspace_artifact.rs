    ...
    WorkspaceSkillArtifactFrontmatter {
        ...
        metadata: frontmatter
            ...
            .map(|value| WorkspaceSkillArtifactMetadataBlocks {
                ...
                rocode: value
                    .rocode
                    .map(|rocode| WorkspaceSkillArtifactRocodeMetadata {
                        requires_tools: rocode.requires_tools,
                        fallback_for_tools: rocode.fallback_for_tools,
                        requires_toolsets: rocode.requires_toolsets,
                        fallback_for_toolsets: rocode.fallback_for_toolsets,
                        stage_filter: rocode.stage_filter,
                    }),
            }),
    }
}
    ...
    SkillFrontmatter {
        ...
        metadata: frontmatter
            ...
            .map(|value| SkillMetadataBlocks {
                ...
                rocode: value.rocode.as_ref().map(|rocode| SkillRocodeMetadata {
                    requires_tools: rocode.requires_tools.clone(),
                    fallback_for_tools: rocode.fallback_for_tools.clone(),
                    requires_toolsets: rocode.requires_toolsets.clone(),
                    fallback_for_toolsets: rocode.fallback_for_toolsets.clone(),
                    stage_filter: rocode.stage_filter.clone(),
                }),
            }),
    }
}
...
mod tests {
    ...
    fn workspace_skill_artifact_roundtrips_through_parse_import_and_re_export() {
        ...
        write_skill(
            &source.path().join(".rocode/skills"),
            "reviewer",
            "reviewer",
            "Review code changes",
