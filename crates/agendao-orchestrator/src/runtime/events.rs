...
pub struct LoopRequest {
    pub messages: Vec<agendao_provider::Message>,
    pub tools: Vec<agendao_provider::ToolDefinition>,
}
...
pub struct LoopOutcome {
    ...
    pub stream_termination: Option<agendao_provider::StreamTermination>,
}

#[derive(Debug, Clone)]
pub enum ModelFailure {
    Provider(agendao_provider::ProviderErrorSummary),
    Message(String),
}
...
impl ModelFailure {
    ...
    pub fn provider_summary(&self) -> Option<&agendao_provider::ProviderErrorSummary> {
        match self {
    ...
    pub fn is_provider_not_found(&self) -> bool {
        matches!(
            ...
            Self::Provider(summary)
                if summary.kind == agendao_provider::ProviderErrorKind::ProviderNotFound
        )
    }
}
...
pub enum LoopError {
    ...
    ModelErrorWithTermination {
        ...
        stream_termination: agendao_provider::StreamTermination,
    },
