...
impl ModelContextLimits {
    pub fn from_model_info(info: &agendao_provider::ModelInfo) -> Self {
        Self {
...
impl Default for CheckpointGovernancePolicy {
    fn default() -> Self {
        Self {
            enabled: true,
            threshold_percent: agendao_types::CONTEXT_PRESSURE_AUTO_COMPACT_SOON_PERCENT,
            critical_percent: agendao_types::CONTEXT_PRESSURE_CRITICAL_PERCENT,
            max_assessments: 2,
