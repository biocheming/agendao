...
fn build_verifier_judge_messages(context: &VerifierJudgeContext) -> Vec<agendao_provider::Message> {
    ...
    vec![
        agendao_provider::Message::system(
        ...
        agendao_provider::Message::user(user_prompt),
    ]
}
...
async fn collect_stream_output_inner(
    stream: &mut agendao_provider::StreamResult,
    cancel_token: Option<&dyn CancelToken>,
) -> Result<CollectedJudgeOutput, OrchestratorError> {
