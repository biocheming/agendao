...
/// matches the actual Message/Content structure used by rocode-provider.
...
#[async_trait::async_trait]
impl rocode_provider::Provider for MockSimpleProvider {
    fn id(&self) -> &str {
        "mock-simple"
    }
    ...
    async fn chat(
        ...
        Ok(rocode_provider::ChatResponse {
            ...
            choices: vec![rocode_provider::Choice {
                index: 0,
                message: rocode_provider::Message::assistant("Simple response"),
