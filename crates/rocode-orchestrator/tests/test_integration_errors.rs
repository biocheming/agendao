...
impl rocode_provider::Provider for MockFailingProvider {
    fn id(&self) -> &str {
        "mock-failing"
    }
...
#[async_trait::async_trait]
impl rocode_provider::Provider for MockSuccessProvider {
    fn id(&self) -> &str {
        "mock-success"
    }
    ...
    async fn chat(
        ...
        Ok(rocode_provider::ChatResponse {
            ...
            choices: vec![rocode_provider::Choice {
                index: 0,
                message: rocode_provider::Message::assistant("Success response"),
