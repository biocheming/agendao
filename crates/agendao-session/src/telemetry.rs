...
use agendao_provider::provider_diagnostic_from_metadata;
use agendao_types::{
...
fn count_kind(rows: &[agendao_types::RepairAggregateRow], kind: RepairKind) -> u64 {
    rows.iter()
...
mod tests {
    ...
    fn telemetry_snapshot_roundtrips_tool_trajectory_quality() {
        ...
        let snapshot = SessionTelemetrySnapshot {
            version: agendao_types::SessionTelemetrySnapshotVersion::V6,
        ...
        assert_eq!(
            loaded.version,
            agendao_types::SessionTelemetrySnapshotVersion::V6
        );
