...
pub fn effective_repair_policy(
    config_store: Option<&agendao_config::ConfigStore>,
) -> agendao_types::RepairPolicy {
    let Some(store) = config_store else {
        return agendao_types::RepairPolicy::Permissive;
    };
    store
        .config()
        .repair_policy
        .unwrap_or(agendao_types::RepairPolicy::Permissive)
}
...
---"#.to_string()
    ...
    pub async fn process<S: SessionOps>(
        ...
        let assistant_id = agendao_core::id::create(agendao_core::id::Prefix::Message, false, None);
        ...
        if let Some(ops) = session_ops {
            ...
            let summary_part = Part::Text {
                id: agendao_core::id::create(agendao_core::id::Prefix::Part, false, None),
                session_id: input.session_id.clone(),
        ...
        if input.auto {
            if let Some(ops) = session_ops {
                ...
                let continue_msg_id =
                    agendao_core::id::create(agendao_core::id::Prefix::Message, false, None);
                ...
                let continue_part_id =
                    agendao_core::id::create(agendao_core::id::Prefix::Part, false, None);
                let now_part = Utc::now().timestamp_millis();
    ...
    pub async fn create<S: SessionOps>(
        ...
        let msg_id = agendao_core::id::create(agendao_core::id::Prefix::Message, false, None);
        let now_ms = Utc::now().timestamp_millis();
        ...
        let part_id = agendao_core::id::create(agendao_core::id::Prefix::Part, false, None);
...
fn resolve_compaction_prompt(
    ...
    hook_outputs: Vec<agendao_plugin::HookOutput>,
) -> String {
...
mod tests {
    ...
    fn strict_policy_defaults_to_permissive_when_unset() {
        ...
        assert_eq!(
            ...
            agendao_types::RepairPolicy::Permissive
        );

        // Config store without explicit repair_policy → permissive.
        let store = agendao_config::ConfigStore::new(agendao_config::Config::default());
        assert_eq!(
