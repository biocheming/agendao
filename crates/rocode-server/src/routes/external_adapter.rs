...
async fn verify_generic_webhook_request(
    ...
    response.authority.replay_store = "rocode-storage.external_adapter_replay:recorded".to_string();
...
mod tests {
    ...
    fn parse_generic_webhook_is_dry_run_only() {
        ...
        assert_eq!(
            ...
            "rocode-storage.external_adapter_replay"
        );
    }
    ...
    async fn verify_generic_webhook_uses_config_auth_and_replay_store() {
        ...
        assert_eq!(
            response.authority.replay_store,
            "rocode-storage.external_adapter_replay:recorded"
        );
