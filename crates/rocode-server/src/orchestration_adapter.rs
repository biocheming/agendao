use rocode_orchestrator::{
    OrchestratorError, PromptExecutionOptions, PromptExecutionResult, SessionDetail,
    SessionSummary,
};
use std::sync::Arc;
...
impl ServerStateOrchestrationAdapter {
    ...
    pub async fn get_session(
        ...
        let session = sessions
            .get(session_id)
            .ok_or_else(|| OrchestratorError::Other(format!("Session not found: {}", session_id)))?;
        ...
        Ok(SessionDetail {
            ...
            messages: record
                ...
                .map(|msg| {
                    ...
                    rocode_orchestrator::MessageSummary {
                        id: msg.id.clone(),
