...
//!
//! By extracting SessionManager here, rocode-orchestrator can depend on rocode-session-core
//! while rocode-session can still depend on rocode-orchestrator for compaction/summary features.
...
// ============================================================================
// Core Types (minimal subset from rocode-session)
// ============================================================================
...
impl Session {
    ...
    pub fn add_user_message_with_source(
        &mut self,
        text: &str,
        origin: rocode_types::MessageSourceOrigin,
        surface: rocode_types::MessageSourceSurface,
    ) -> String {
    ...
    fn add_user_message_inner(&mut self, text: &str, metadata: HashMap<String, serde_json::Value>) -> String {
        use rocode_types::{SessionMessage, MessageRole, MessagePart, PartType};
...
/// The default `SessionManager` implements this; `rocode_session::SessionManager`
/// also implements it so `rocode-server` can inject the unified authority.
