...
/// `agendao_session::SessionManager` for unified authority.
...
impl DirectTransport<CoreSessionManager> {
    ...
    pub async fn new(config: &agendao_config::Config) -> Result<Self> {
...
impl<S: SessionStore> DirectTransport<S> {
    ...
    pub async fn prompt(
        ...
        let exec_options = agendao_orchestrator::PromptExecutionOptions {
            ...
            source_origin: options
                .source_origin
                .or(Some(agendao_types::MessageSourceOrigin::Operator)),
        ...
        Ok(sessions
            ...
            .map(|s| {
                ...
                SessionListItem {
                    ...
                    version: String::new(),
                    time: agendao_types::SessionTime {
                        created: 0,
                        updated: 0,
                        compacting: None,
                        archived: None,
