...
const rustSourcePath = resolve(repoRoot, "crates/agendao-types/src/context_pressure.rs");
const outputPath = resolve(repoRoot, "apps/agendao-web/src/generated/contextPressure.generated.ts");
...
function generatedContent(source) {
  ...
  return `// Generated from crates/agendao-types/src/context_pressure.rs. Do not edit by hand.\n` +
    `\n` +
