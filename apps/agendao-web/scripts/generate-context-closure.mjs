...
const rustSourcePath = resolve(repoRoot, "crates/agendao-types/src/session.rs");
const outputPath = resolve(repoRoot, "apps/agendao-web/src/generated/contextClosure.generated.ts");
