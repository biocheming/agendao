...
function isolatedWorkspaceNotice(tab: SettingsTabId): string | null {
  switch (tab) {
    ...
    case "providers":
      return "Provider and model changes made here target global config or shared provider state. The current isolated sandbox will not inherit those global config changes unless the same intent is expressed inside this workspace's .agendao.";
    case "memory":
    ...
    case "skills":
      return "Skill mutations here always target this workspace's .agendao/skills. In isolated mode, that means the current sandbox stays local and does not inherit or modify global skill config.";
    case "mcp":
    ...
    case "plugins":
      return "Plugin config saved here is global. The current isolated sandbox will not inherit those global config changes unless they are mirrored into this workspace's .agendao authority.";
    default:
      return null;
  }
}
          ...
          {!loading && activeTab === "general" ? (
            <div className="grid gap-6">
              ...
              <div className="grid gap-3">
                ...
                >
                  {workspaceMode === "isolated"
                    ? "This workspace runs as an isolated sandbox. It will not inherit global config, managed home config, or shared workspace overrides outside this .agendao root."
